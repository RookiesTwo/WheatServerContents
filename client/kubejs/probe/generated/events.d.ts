 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.createbigcannons.cannon_cast_shapes", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.createbigcannons.block_recipe_types", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**, **client**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.createbigcannons.block_recipe_serializers", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
...
declare function onForgeEvent(name: "me.pepperbell.continuity.client.util.ClientJoinEvent", handler: (event: Internal.ClientJoinEvent) => void);
